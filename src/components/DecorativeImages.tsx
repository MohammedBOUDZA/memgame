...
const DecorativeImages: React.FC = () => {
  return (
    <>
      ...
      <div className="hidden md:block fixed left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/2 opacity-20 pointer-events-none z-0">
        <img 
          ...
          className="w-48 h-48 lg:w-64 lg:h-64 object-cover rounded-full blur-sm"
        />
      </div>
      
      {/* Right side decorative elements - Hidden on mobile */}
      <div className="hidden md:block fixed right-0 top-1/3 transform -translate-y-1/2 translate-x-1/2 opacity-20 pointer-events-none z-0">
        <img 
          src="https://images.pexels.com/photos/442576/pexels-photo-442576.jpeg?auto=compress&cs=tinysrgb&w=400" 
          alt="Cards decoration"
          className="w-40 h-40 lg:w-48 lg:h-48 object-cover rounded-full blur-sm"
        />
      </div>
      
      {/* Bottom left decorative element - Hidden on small screens */}
      <div className="hidden lg:block fixed left-10 bottom-10 opacity-15 pointer-events-none z-0">
        <img 
      ...
      {/* Top right decorative element - Hidden on small screens */}
      <div className="hidden lg:block fixed right-10 top-20 opacity-15 pointer-events-none z-0">
        <img 
      ...
      <div className="fixed top-1/4 left-1/4 opacity-10 pointer-events-none z-0 animate-pulse">
        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full blur-sm"></div>
      </div>
      
      <div className="fixed top-3/4 right-1/4 opacity-10 pointer-events-none z-0 animate-pulse" style={{ animationDelay: '1s' }}>
        <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full blur-sm"></div>
      </div>
      
      <div className="fixed top-1/2 right-1/3 opacity-10 pointer-events-none z-0 animate-pulse" style={{ animationDelay: '2s' }}>
        <div className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-br from-green-400 to-emerald-400 rounded-full blur-sm"></div>
      </div>
    </>
  );
};
